...
status: publish
published: true
title: 《Unity3D高级编程之进阶主程》第四章，UI(四) - UGUI渲染部分的核心源码剖析
...
### 至此我们把 UGUI 的核心代码部分都剖析完毕了。其实也并没有什么高深的算法，或者技术。所有核心部分都围绕着，如何构建Mesh，如何重构Mesh，以及如何裁切的问题上。如果想仔细阅读源码，可以去如下地址获得源码。
